...
* [CodeIgniter 4 User Guide on Testing](https://codeigniter4.github.io/userguide/testingdashboard)
...
The HTML files can be viewed by opening **tests/coveragedashboard** in your favorite browser.
